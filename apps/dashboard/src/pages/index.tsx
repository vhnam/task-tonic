...
export default function Home() {
  return (
    <div
      className={`${manropeSans.variable} grid min-h-screen grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 p-8 pb-20 font-[family-name:var(--font-manrope-sans)] sm:p-20`}
    >
